...
@export var character_1: CharacterBody3D
@export var character_2: CharacterBody3D
...
func _process(delta: float) -> void:
	$Label.text = "Player state:  "  + str(character_1.PlayerState.keys()[character_1.current_state]) + "\n"  
	$Label.text += "Player2 state: " + str(character_2.PlayerState.keys()[character_2.current_state])
